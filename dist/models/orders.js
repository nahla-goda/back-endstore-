...
var orderinfo = /** @class */ (function () {
    ...
    orderinfo.prototype.delete = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_1 = _a.sent();
                        throw new Error("Could not delete orders".concat(id, ", ").concat(error_1.message));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        connection = _a.sent();
                        sql = 'INSERT INTO orders (user_id, status) VALUES ($1, $2 ) RETURNING id, user_id,status';
                        return [4 /*yield*/, connection.query(sql, [
                                o.user_id,
                                o.status
                            ])
    ...
    orderinfo.prototype.addProduct = function (quantity, order_Id, product_id) {
        return __awaiter(this, void 0, void 0, function () {
