...
var token = (0, createtoken_1.createAuthToken)('test');
describe('Order model ENDpoint', function () {
    var user = {
    ...
    describe('Test CRUD API methods for order', function () {
        ...
        it('should return  list of order', function () { return __awaiter(void 0, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, request
        ...
        it('should return  order by id ', function () { return __awaiter(void 0, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, request
        ...
        it('should delete order by ', function () { return __awaiter(void 0, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, request
