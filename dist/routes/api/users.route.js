...
exports.authenticate = exports.update = exports.deleteOne = exports.create = exports.show = exports.index = void 0;
var users_1 = __importDefault(require("../../models/users"));
var jsonwebtoken_1 = __importDefault(require("jsonwebtoken"));
var createtoken_1 = require("../../middleware/createtoken");
//index route
var usersroute = new users_1.default();
var index = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, usersroute.index()];
            case 1:
                user = _a.sent();
                res.json(user);
                return [3 /*break*/, 3];
...
var show = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, usersroute.show(parseInt(req.params.id))];
            case 1:
                user = _a.sent();
                res.json(user);
                return [3 /*break*/, 3];
...
var create = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, usersroute.create(req.body)];
            case 1:
                user = _a.sent();
                token = (0, createtoken_1.createAuthToken)(req.body);
                res.json({
...
var deleteOne = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, usersroute.delete(req.params.id)];
            case 1:
                _a.sent();
                res.json({
...
var update = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, user_name, first_name, last_name, email, password, user, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                ...
                return [4 /*yield*/, usersroute.update(id, {
                        email: email,
                        user_name: user_name,
...
var authenticate = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, usersroute.authenticate(req.body.email, req.body.password)];
            case 1:
                user = _a.sent();
